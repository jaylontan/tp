...
public class JsonSerializableAddressBookTest {
    ...
    private static final Path TYPICAL_BOOKINGS_FILE = TEST_DATA_FOLDER.resolve("typicalPersonsAddressBook.json");
    ...
    public void toModelType_typicalBookingsFile_success() throws Exception {
        JsonSerializableAddressBook dataFromFile = JsonUtil.readJsonFile(TYPICAL_BOOKINGS_FILE,
                JsonSerializableAddressBook.class).get();
        AddressBook addressBookFromFile = dataFromFile.toModelType();
        AddressBook typicalBookingsAddressBook = TypicalBookings.getTypicalAddressBookWithBookings();
